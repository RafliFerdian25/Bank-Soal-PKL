            ...
            <div class="mx__max container-fluid">
                ...
                <div class="justify-content-end collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item align-self-center mx-4">
                            <a class="nav-link text__white fw__sb px-2" id="nav__sekolah"
                                href="<?= base_url(); ?>/sekolah/sekolah">Sekolah</a>
                        </li>
                        <li class="nav-item align-self-center mx-4">
                            <a class="nav-link text__white fw__sb px-2" id="nav__guru"
                                href="<?= base_url(); ?>/guru/guru">Guru</a>
                        </li>
                        <li class="nav-item align-self-center mx-4">
                            <a class="nav-link text__white fw__sb px-2" id="nav__soal"
                                href="<?= base_url(); ?>/mapel/mapel">Soal</a>
                        </li>
                        <li class="nav-item align-self-center mx-4 dropdown">
                            ...
                            <ul class="dropdown-menu min-w__20 p-2" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="<?= base_url(); ?>/user/daftar_akun">Manajemen
                                        akun</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
